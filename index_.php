...
<section class="frontpage_video">
  <video autoplay loop muted src="video/DecoChef-HS-1920x1080.mov" class="hs-video">
  </video>
  <button class="play-pause"><i class="fa-solid fa-pause"></i></button>
  <button class="mute-unmute"><i class="fa-solid fa-volume-high"></i></button>
</section>
<section class="frontpage_iphone_video">
  <video autoplay loop muted src="video/DecoChef-HS-Mobile.mov" class="mo-video">
  </video>
  <button class="play-paus"><i class="fa-solid fa-pause"></i></button>
  <button class="mute-unmut"><i class="fa-solid fa-volume-high"></i></button>
</section>
  ...
  <div class="container">
    ...
    <div class="chef">
      ...
      <div class="ing_box">
        ...
        <div class="svg_outbox">
          <div class="svg_videotest">
            <div class="fork"><a href="./recipe-main.php"><img src="imgs/front page-T/fork.svg" alt=""></div>
      ...
      <div class="ing_box ">
        ...
        <div class="svg_outbox">
          <div class="svg_videotest">
            <div class="video"><a href="./recipe-lifestyle.php"><img src="imgs/front page-T/video.svg" alt=""></div>
      ...
      <div class="ing_box">
        ...
        <div class="svg_outbox">
          <div class="svg_videotest">
            <div class="fave"><a href="./recipe-lifestyle.php"><img class="testing" src="imgs/front page-T/fave.svg" alt=""></div>
...
<section class="bestseller">
  ...
  <div class="pa-card pa4-img pa4">
    <a href="../Decochef/products-intro.php?sid=80">
      <div class="pa-text"></div>
    </a>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="mapinfo">
        ...
        <div class="ppa">
          <div class="row ppe"><img src="imgs/front page-T/Vector.svg" alt="">體驗店</div>
          <div class="row ppe"><img src="imgs/front page-I/test.svg " alt="">旗艦店</div>
          <div class="row ppe"><img src="imgs/front page-I/fix.svg" alt="">維修店</div>
        </div>
        ...
        <div class="adress_shop">
          ...
          <h6>信義門市</h6></a><img src="imgs/front page-I/p-fix.svg" alt=""></div>
          ...
          <div class="adress_shop"> <h6>大安門市</h6>
          </a><img src="imgs/front page-T/thin.svg" alt=""><img src="imgs/front page-I/p-fix.svg" alt=""></div>
          ...
          <div class="adress_shop"> <h6>信義門市</h6>
          </a><img src="imgs/front page-T/thin.svg" alt=""></div>
        ...
        <div class="adress2">
          ...
          <div class="adress_shop"><h6>台中門市</h6>
          </a><img src="imgs/front page-T/thin.svg" alt=""><img src="imgs/front page-I/p-fix.svg" alt=""></div>
...
$(document).ready(function() {
  var video = $(".mo-video")[0]; // 获取视频元素
  
  $(".play-paus").click(function() {
    if (video.paused) {
      video.play(); // 播放视频
    } else {
      video.pause(); // 暂停视频
