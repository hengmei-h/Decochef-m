        ...
        <div class="slider-window">
            <div class="container slider-window-f">
                <ul class="slider-window-card">
                    <li>
                        <img src="./imgs/products-imgs/banner.jpg" alt="" />
                    </li>
                    <li>
                        <img src="./imgs/products-imgs/banner2.jpg" alt="" />
                    </li>
                    <li>
                        <img src="./imgs/products-imgs/banner3.jpg" alt="" />
                    </li>
                    <li>
                        <img src="./imgs/products-imgs/banner4.jpg" alt="" />
                    </li>
                    <li>
                        <img src="./imgs/products-imgs/banner5.jpg" alt="" />
                    </li>
                </ul>
